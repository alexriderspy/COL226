...
and pf_exp(h) = 
    ...
    |   PLUS(VEXP(a),IEXP(b)) => ([a]@[Int.toString(b)]@["PLUS"])
    |   PLUS(IEXP(a),VEXP(b)) => ([Int.toString(a)]@[b]@["PLUS"])
    ...
    |   MINUS(VEXP(a),IEXP(b)) => ([a]@[Int.toString(b)]@["MINUS"])
    |   MINUS(IEXP(a),VEXP(b)) => ([Int.toString(a)]@[b]@["MINUS"])
    ...
    |   TIMES(VEXP(a),IEXP(b)) => ([a]@[Int.toString(b)]@["TIMES"])
    |   TIMES(IEXP(a),VEXP(b)) => ([Int.toString(a)]@[b]@["TIMES"])
    ...
    |   DIV(VEXP(a),IEXP(b)) => ([a]@[Int.toString(b)]@["DIV"])
    |   DIV(IEXP(a),VEXP(b)) => ([Int.toString(a)]@[b]@["DIV"])
    ...
    |   MOD(VEXP(a),IEXP(b)) => ([a]@[Int.toString(b)]@["MOD"])
    |   MOD(IEXP(a),VEXP(b)) => ([Int.toString(a)]@[b]@["MOD"])
    ...
    |   AND(VEXP(a),BEXP(b)) => ([a]@[Bool.toString(b)]@["AND"])
    |   AND(BEXP(a),VEXP(b)) => ([Bool.toString(a)]@[b]@["AND"])
    ...
    |   OR(VEXP(a),BEXP(b)) => ([a]@[Bool.toString(b)]@["OR"])
    |   OR(BEXP(a),VEXP(b)) => ([Bool.toString(a)]@[b]@["OR"])
    ...
    |   LT(VEXP(a),IEXP(b)) => ([a]@[Int.toString(b)]@["LT"])
    |   LT(VEXP(a),BEXP(b)) => ([a]@[Bool.toString(b)]@["LT"])
    |   LT(IEXP(a),VEXP(b)) => ([Int.toString(a)]@[b]@["LT"])
    |   LT(BEXP(a),VEXP(b)) => ([Bool.toString(a)]@[b]@["LT"])
    ...
    |   LEQ(VEXP(a),IEXP(b)) => ([a]@[Int.toString(b)]@["LEQ"])
    |   LEQ(VEXP(a),BEXP(b)) => ([a]@[Bool.toString(b)]@["LEQ"])
    |   LEQ(IEXP(a),VEXP(b)) => ([Int.toString(a)]@[b]@["LEQ"])
    |   LEQ(BEXP(a),VEXP(b)) => ([Bool.toString(a)]@[b]@["LEQ"])
    ...
    |   GT(VEXP(a),IEXP(b)) => ([a]@[Int.toString(b)]@["GT"])
    |   GT(VEXP(a),BEXP(b)) => ([a]@[Bool.toString(b)]@["GT"])
    |   GT(IEXP(a),VEXP(b)) => ([Int.toString(a)]@[b]@["GT"])
    |   GT(BEXP(a),VEXP(b)) => ([Bool.toString(a)]@[b]@["GT"])
    ...
    |   GEQ(VEXP(a),IEXP(b)) => ([a]@[Int.toString(b)]@["GEQ"])
    |   GEQ(VEXP(a),BEXP(b)) => ([a]@[Bool.toString(b)]@["GEQ"])
    |   GEQ(IEXP(a),VEXP(b)) => ([Int.toString(a)]@[b]@["GEQ"])
    |   GEQ(BEXP(a),VEXP(b)) => ([Bool.toString(a)]@[b]@["GEQ"])
    ...
    |   EQ(VEXP(a),IEXP(b)) => ([a]@[Int.toString(b)]@["EQ"])
    |   EQ(VEXP(a),BEXP(b)) => ([a]@[Bool.toString(b)]@["EQ"])
    |   EQ(IEXP(a),VEXP(b)) => ([Int.toString(a)]@[b]@["EQ"])
    |   EQ(BEXP(a),VEXP(b)) => ([Bool.toString(a)]@[b]@["EQ"])
    ...
    |   NEQ(VEXP(a),IEXP(b)) => ([a]@[Int.toString(b)]@["NEQ"])
    |   NEQ(VEXP(a),BEXP(b)) => ([a]@[Bool.toString(b)]@["NEQ"])
    |   NEQ(IEXP(a),VEXP(b)) => ([Int.toString(a)]@[b]@["NEQ"])
    |   NEQ(BEXP(a),VEXP(b)) => ([Bool.toString(a)]@[b]@["NEQ"])
