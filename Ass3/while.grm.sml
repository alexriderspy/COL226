...
|  ( 4, ( ( _, ( _, _, INT1right)) :: _ :: ( _, ( MlyValue.varList 
varList1, _, _)) :: ( _, ( _, VAR1left, _)) :: rest671)) => let val  
result = MlyValue.dec (fn _ => let val  (varList as varList1) = 
varList1 ()
 in (INT(varList))
end)
 in ( LrTable.NT 3, ( result, VAR1left, INT1right), rest671)
end
|  ( 5, ( ( _, ( _, _, BOOL1right)) :: _ :: ( _, ( MlyValue.varList 
varList1, _, _)) :: ( _, ( _, VAR1left, _)) :: rest671)) => let val  
result = MlyValue.dec (fn _ => let val  (varList as varList1) = 
varList1 ()
 in (BOOL(varList))
end)
 in ( LrTable.NT 3, ( result, VAR1left, BOOL1right), rest671)
end
