...
\\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000"
 ...
 (3, 
"\006\006\006\006\006\006\006\006\006\033\036\006\006\035\006\006\
\\006\006\006\006\006\006\006\006\006\006\006\006\006\006\006\006\
\\033\032\006\006\006\031\006\006\030\029\028\027\026\025\006\024\
...
{fin = [(N 24),(N 65)], trans = 0},
{fin = [(N 65)], trans = 9},
{fin = [(N 63)], trans = 0},
{fin = [(N 22),(N 65)], trans = 0},
{fin = [(N 11),(N 65)], trans = 12},
{fin = [(N 11)], trans = 12},
{fin = [(N 44),(N 65)], trans = 14},
{fin = [(N 47)], trans = 0},
{fin = [(N 42),(N 65)], trans = 0},
{fin = [(N 37),(N 65)], trans = 17},
{fin = [(N 50)], trans = 0},
{fin = [(N 40)], trans = 0},
{fin = [(N 18),(N 65)], trans = 0},
{fin = [(N 16),(N 65)], trans = 21},
{fin = [(N 27)], trans = 0},
{fin = [(N 14)], trans = 0},
{fin = [(N 58),(N 65)], trans = 0},
{fin = [(N 54),(N 65)], trans = 0},
{fin = [(N 20),(N 65)], trans = 0},
{fin = [(N 52),(N 65)], trans = 0},
{fin = [(N 56),(N 65)], trans = 0},
{fin = [(N 33),(N 65)], trans = 0},
{fin = [(N 31),(N 65)], trans = 0},
{fin = [(N 60),(N 65)], trans = 0},
{fin = [(N 35),(N 65)], trans = 0},
{fin = [(N 3),(N 65)], trans = 33},
{fin = [(N 3)], trans = 33},
{fin = [(N 8),(N 65)], trans = 35},
{fin = [(N 8)], trans = 0}])
end
...
| 37 => (col:=yypos-(!eolpos); T.LT(!lin,!col))
| 40 => (col:=yypos-(!eolpos); T.LE(!lin,!col))
| 42 => (col:=yypos-(!eolpos); T.EQUALS(!lin,!col))
| 44 => (col:=yypos-(!eolpos); T.GT(!lin,!col))
| 47 => (col:=yypos-(!eolpos); T.GE(!lin,!col))
| 50 => (col:=yypos-(!eolpos); T.NE(!lin,!col))
| 52 => (col:=yypos-(!eolpos); T.SUM(!lin,!col))
| 54 => (col:=yypos-(!eolpos); T.DIFF(!lin,!col))
| 56 => (col:=yypos-(!eolpos); T.MUL(!lin,!col))
| 58 => (col:=yypos-(!eolpos); T.DIV(!lin,!col))
| 60 => (col:=yypos-(!eolpos); T.MOD(!lin,!col))
| 63 => (col:=yypos-(!eolpos); T.DBAR(!lin,!col))
| 65 => let val yytext=yymktext() in col:=yypos-(!eolpos);
